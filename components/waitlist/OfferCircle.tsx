...
export function OfferCircle() {
  return (
    <div
      className="
        static order-2 my-1.5 mx-auto flex justify-center
        tablet:absolute tablet:left-1/2 tablet:top-1/2 tablet:z-[5] tablet:order-none tablet:m-0 tablet:block
        tablet:[transform:translate(-58%,-46%)]
      "
    >
      {/* Entrance pop lives on this inner wrapper so it never clobbers the outer
          element's centering transform (translate(-58%,-46%) on tablet+). */}
      <motion.div
      ...
      >
        <div
          className="animate-breathe relative flex h-[246px] w-[246px] flex-col items-center justify-center rounded-full border-[3px] text-center text-white"
          style={{
            background:
              "radial-gradient(circle at 42% 32%, #F9B451 0%, #F39B28 46%, #E5851A 100%)",
        ...
        >
          ...
          <div
            className="mt-0.5 text-[10px] font-medium opacity-90"
